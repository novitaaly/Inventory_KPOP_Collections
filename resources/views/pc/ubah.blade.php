                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{url("album/detail/".$pc->ID_ALBUM)}}">Detail Album</a></li>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text"  class="form-control" id="member" name="member" placeholder="Member" required value="{{$pc->MEMBER}}">
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label for="idol">Idol Group</label>
                                                <input type="text"  class="form-control" id="idol" name="idol" placeholder="Idol Group" required value="{{$pc->IDOL_GROUP}}">
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label for="type">Type</label>
                                                <input type="text"  class="form-control" id="type" name="type" placeholder="Type" required value="{{$pc->PC_TYPE}}">
                                            </div>
                                        </div>
